...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.intercambiodechaquetas, getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.lavanderia, getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.entrega, getTheme());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menuservicios, menu);
        return true;
    }
